package alquilervehiculos.mvc.vista.iugrafica.utilidades;
...
public class Dialogos {
	...
	public static void mostrarDialogoError(String titulo, String contenido, Stage propietario) {
		...
		dialogo.getDialogPane().getStylesheets().add(Dialogos.class.getResource("../iugrafica.css").toExternalForm());
